...
class DashboardRenderer:
    ...
    def _update_panels(self, layout: Layout):
        ...
        header_text = Text(f"Specter Network Scanner | Elapsed: {elapsed_str} | Target Size: {self.targets_total}", justify="center", style="bold green")
        ...
        layout["stats"].update(Panel(Align.center(stats_table, vertical="middle"), title="Scan Progress", border_style="cyan"))
